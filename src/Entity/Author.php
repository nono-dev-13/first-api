...
class Author
{
    ...
    #[Assert\Length(min: 1, max: 255, minMessage: "Le nom de l'Auteur doit faire au moins {{ limit }} caractères", maxMessage: "Le nom de l'Auteur ne peut pas faire plus de {{ limit }} caractères")]
